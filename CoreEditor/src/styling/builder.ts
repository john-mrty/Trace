...
const sharedStyles: { [selector: string]: StyleSpec } = {
  ...
  '.cm-md-tocIndicator:hover .cm-md-tocDashes': {
    opacity: '0',
    pointerEvents: 'none',
  },
  '.cm-md-tocDash': {
  ...
  '.cm-md-tocIndicator:hover .cm-md-tocPanel': {
    opacity: '1',
    pointerEvents: 'auto',
  },
  ...
  '.cm-md-frontMatterChipOpen': {
    opacity: '1',
  },
  '.cm-md-frontMatterTable': {
    margin: '6px 0 0 2px',
    fontSize: '0.85em',
    opacity: '0.8',
  },
  '.cm-md-frontMatterKey': {
    display: 'inline-block',
    minWidth: '96px',
    opacity: '0.6',
    marginRight: '8px',
