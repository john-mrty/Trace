...
enum Localized {
  ...
  enum Settings {
    ...
    static let systemDefault = String(localized: "Sans", comment: "System default font name")
    static let systemMono = String(localized: "Mono", comment: "System mono font name")
    static let systemRounded = String(localized: "System Rounded", comment: "System rounded font name")
    static let systemSerif = String(localized: "Serif", comment: "System serif font name")
